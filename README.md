...
### Builder
[Builder (Строитель)](https://github.com/klesarev/kotlin-learn/blob/master/src/main/kotlin/patterns/Builder.kt) - 
...
### State
[State](src/main/kotlin/patterns/State.kt), или Состояние - это поведенческий паттерн проектирования, 
...
## Алгоритмы
### Числа Фибоначчи
[Числа Фибоначчи](src/main/kotlin/algorithms/Fibonacci.kt) (строка Фибоначчи) — числовая последовательность, 
первые два числа которой являются 0 и 1, а каждое 
последующее за ними число является суммой двух предыдущих.

### Факториал числа
[Факториалом числа](src/main/kotlin/algorithms/Factorial.kt) называют произведение всех натуральных чисел до него 
включительно. Например, факториал числа 5 равен 
произведению 1 * 2 * 3 * 4 * 5 = 120.

### FizzBuzz
[FizzBuzz](src/main/kotlin/algorithms/FizzBuzz.kt) - часто встречающаяся задача на собеседованиях. Условие - 
...
задачах. Текст с задачами и исходник с решениями задач [лежит тут](src/main/kotlin/interview/)
