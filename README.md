...
- [Повторяющиеся элементы из списка](src/main/kotlin/interview/README.md#Повторяющиеся элементы из списка)
- [Количество повторений в строке](src/main/kotlin/interview/README.md#Количество повторений в строке)
- [Реверс (переворот строки)](src/main/kotlin/interview/README.md#Переворот строки)
